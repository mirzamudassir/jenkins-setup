pipeline{
    ...
    post{
        always{
            ...
            emailext body: 'A Test EMail to commitor', recipientProviders: [[$class: 'DevelopersRecipientProvider'], [$class: 'RequesterRecipientProvider']], [$class:'UpstreamComitterRecipientProvider']], subject: 'Test'
        }
        success{
